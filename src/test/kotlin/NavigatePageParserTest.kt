...
class NavigatePageParserTest {
    @Test fun `navigate page gives correct chapter links`() {
        val testHtml = Jsoup.parse(wholePage)
        val response = parseNavigatePageForChapterList(testHtml)
        assert(response.size == 3)
        assert(response[0] == "/works/76328156/chapters/199763626")
    }
...
<html lang="en"><head>
    ...
    <title>Navigate Work | Archive of Our Own</title>
...
<meta name="csrf-token" content="xyxzIrPLbfWt-twFZPyZ12tvf3bmm2Yan2--YlWAPI_Kr6OUboc58NVocOeSF9AgXUVye8NQRGY_MulLLMfaTg">
  ...
  <h1 class="heading">
    ...
    <div id="login" class="dropdown" aria-haspopup="true">
      <p class="user actions">
        <a id="login-dropdown" href="/users/login?return_to=%2Fworks%2F76328156%2Fnavigate" class="dropdown-toggle" data-toggle="dropdown" data-target="#">Log In</a>
      </p>
      <div id="small_login" class="simple login">
	<form class="new_user" id="new_user_session_small" action="/users/login?return_to=%2Fworks%2F76328156%2Fnavigate" accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="xyxzIrPLbfWt-twFZPyZ12tvf3bmm2Yan2--YlWAPI_Kr6OUboc58NVocOeSF9AgXUVye8NQRGY_MulLLMfaTg" autocomplete="off">
  <dl>
...
<!-- END header -->
      ...
      <div id="inner" class="wrapper">
        ...
        <div id="main" class="works-navigate region" role="main">
          ...
          <div class="flash"></div>
          <h2 class="heading">Chapter Index for <a href="/works/76328156">Yule Be Surprised</a> by <a rel="author" href="/users/Dorothea_Greengrass/pseuds/Dorothea_Greengrass">Dorothea_Greengrass</a></h2>

<ol class="chapter index group" role="navigation">
  <li><a href="/works/76328156/chapters/199763626">1. Chapter 1</a> <span class="datetime">(2025-12-24)</span></li>
  <li><a href="/works/76328156/chapters/201150046">2. Chapter 2</a> <span class="datetime">(2026-01-01)</span></li>
  <li><a href="/works/76328156/chapters/210068306">3. Chapter 3</a> <span class="datetime">(2026-02-22)</span></li>
</ol>
